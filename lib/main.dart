...
final lightTheme = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    seedColor: const Color.fromARGB(255, 255, 255, 255), // Primary color for the light theme
...
final darkTheme = ThemeData(
  useMaterial3: true,
  colorScheme: ColorScheme.fromSeed(
    seedColor: const Color.fromARGB(230, 0, 0, 0), // Primary color for the dark theme
